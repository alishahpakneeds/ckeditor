...
(function() {
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
   ...
   getDocumentPosition: function(a) {
    ...
    if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
     ...
     for (n = this, w = null; n && "body" != n.getName() &&
     "html" != n.getName();) {
   ...
   copyAttributes: function(a, b) {
    ...
    for (var f = 0; f < c.length; f++) {
     var d = c[f],
         ...
         r;
     if (!(e in b))
      if ("checked" == e && (r = this.getAttribute(e))) a.setAttribute(e, r);
      else if (!CKEDITOR.env.ie || this.hasAttribute(e)) r = this.getAttribute(e), null === r && (r = d.nodeValue), a.setAttribute(e, r)
    }
 ...
 (function() {
  ...
  function d(a, b, c, d, e) {
   ...
   function g() {
    ...
    for (a = 0; a < f; a++)
     if (b = N[a], c = C[a], !b.equals(c)) return a;
    return a - 1
   }
   ...
   var p = a.startContainer,
       ...
       z = a.endOffset,
       F, B, E, v, q, O;
   if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(x, z)), c.append(p);
   else {
    ...
    J = c;
    for (Q = I; Q <= K; Q++)
     if (c = C[Q], U = c.getPrevious(), c.equals(N[Q])) b && (J = J.getChild(0));
     else {
  ...
  CKEDITOR.dom.range.prototype = {
    ...
    switch (a) {
     ...
     case CKEDITOR.ENLARGE_ELEMENT:
      ...
      for (h = c(h); h || p;) {
       ...
       for (; p;)
        if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
         ...
         if (p.type == CKEDITOR.NODE_TEXT) F = p.getText(), d.test(F) && (p = null), z = /[\s\ufeff]$/.test(F);
         else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))
          if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
           F = p.getText();
           if (d.test(F)) p = null;
           else
            for (var B = p.$.getElementsByTagName("*"), E = 0, v; v =
                B[E++];)
      ...
      for (; h ||
       ...
       for (; p;) {
        z = !1;
        if (p.type == CKEDITOR.NODE_TEXT) F = p.getText(), n(p, 0) || (p = null), z = /^[\s\ufeff]/.test(F);
         ...
         if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))
          if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
           ...
           if (d.test(F)) p = null;
            ...
            for (B = p.$.getElementsByTagName("*"), E =
                0; v = B[E++];)
             if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) {
              p = null;
              break
   ...
   moveToClosestEditablePosition: function(a, b) {
    ...
    else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (n = e.type == CKEDITOR.NODE_ELEMENT) &&
 ...
 (function() {
  function a(a, b, c, d, e) {
   ...
   for (d = a.length; c < d; ++c) {
    ...
    if (!0 === h.elements ||
     ...
     for (z in m = h.elements, delete h.elements, m)
      if (b[z]) b[z][p ? "unshift" : "push"](h);
      else b[z] = [h]
   }
  }
  ...
  function r(a, b, h, e) {
   ...
   if (e.doCallbacks && a.elementCallbacks) {
    a: {
     ...
     for (var g = 0, t = f.length, x; g < t; ++g)
      if (x = f[g](b)) {
       f = x;
       break a
      }
   ...
   if (e.doFilter) {
    a: {
     g = b.name;t = a._;a = t.allowedRules.elements[g];f = t.allowedRules.generic;g = t.disallowedRules.elements[g];t = t.disallowedRules.generic;
     x = e.skipRequired;
     var F = {
          valid: !1,
          validAttributes: {},
     ...
     if (a || f) {
      ...
      if (t)
       for (k = 0, C = t.length; k < C; ++k) c(t[k], b, F);
      if (a)
       for (k = 0, C = a.length; k < C; ++k) d(a[k], b, F, x);
      if (f)
       for (k = 0, C = f.length; k < C; ++k) d(f[k], b, F, x);
      a = F
     } else a = null
    }
    if (!a || !a.valid) return h.push(b), 1;C = a.validAttributes;
    var z = a.validStyles;
    f = a.validClasses;
    var g = b.attributes,
        l = b.styles,
        t = b.classes;x = b.classBackup;
    var J = b.styleBackup,
        B, I, E = [],
        F = [],
        q = /^data-cke-/;k = !1;delete g.style;delete g["class"];delete b.classBackup;delete b.styleBackup;
    if (!a.allAttributes)
     for (B in g) C[B] || (q.test(B) ? B == (I = B.replace(/^data-cke-saved-/, "")) || C[I] || (delete g[B], k = !0) : (delete g[B], k = !0));
  ...
  function h(a, b, c) {
   ...
   if (B.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
    ...
    if ("br" == b) a.previous && !t(a.previous) && (b = u(), b.insertBefore(a)), a.next && !t(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren();
    else {
     var d = a.children,
         h;
     b: {
      ...
      for (var p = 0, e = d.length, m; p < e; ++p)
       if (m = d[p], m.type == CKEDITOR.NODE_ELEMENT && !h[m.name]) {
        h = !1;
        break b
       }
      h = !0
  ...
  function m(a, b) {
   ...
   for (p in d)
    if ("class" == p)
     for (c = d[p].split(/\s+/), m = a.classes.join("|"); f = c.pop();) {
  ...
  CKEDITOR.filter.prototype = {
   ...
   applyTo: function(a, b, c, d) {
      ...
      a: {
       ...
       if (m)
        for (t = 0; t < m.length; ++t)
         if ((x = d.match(m[t])) && x[0].length == d.length) {
          c = !0;
          break a
         }
       d = CKEDITOR.htmlParser.fragment.fromHtml(d);1 == d.children.length && (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT && r(p, h, c, n);c = !c.length
      }
      c || e.push(a)
     }
    }, null, !0);
    ...
    for (; t = a.pop();)
     if (c = t.el, c.parent) switch (x = B[c.parent.name] || B.span, t.check) {
      case "it":
  ...
  J = CKEDITOR.filter.transformationsTools = {
   ...
   transform: function(a, b) {
    if ("string" == typeof b) a.name = b;
     ...
     for (p in h)
      if ("class" == p)
       for (c = a.classes.join("|"), m = h[p].split(/\s+/); f = m.pop();) - 1 == c.indexOf(f) && a.classes.push(f);
  ...
  load: function(a, d, b) {
   ...
   CKEDITOR.scriptLoader.load(g, function(a, e) {
    ...
    for (var f = 0; f < a.length; f++)
     for (var g = k[a[f]], n = 0; n < g.length; n++) {
      var w = g[n];
      l[w] = this.get(w);
      c[w] = 1
     }
       ...
       k = function(b) {
        a.call(this, b, function(a) {
         ...
         for (f in a) {
          ...
          if (!d[f]) {
           if (l.icons)
            for (var r = l.icons.split(","), D = r.length; D--;) CKEDITOR.skin.addIcon(r[D], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + r[D] + ".png");
           d[f] = 1
          }
          if (A)
  ...
  function y(a) {
   ...
   CKEDITOR.plugins.load(c.split(","), function(c) {
    ...
    for (var f in c) {
     ...
     if (l && (q = l.match(p)))
      for (; l = q.pop();) CKEDITOR.error("editor-plugin-required", {
       plugin: l.replace(",", ""),
       requiredBy: f
      });
  ...
  CKEDITOR.htmlParser.fragment.fromHtml =
      function(g, k, l) {
         ...
         if ("br" == e) H.push(m);
          ...
          for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || u.isUnknown || g[e]);)
           if (u.isOptionalClose) D.onTagClose(f);
               ...
               !r(e, f)) D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
           else if (f in d && !r(e, f)) !m.returnPoint && (m.returnPoint = u), u = u.parent;
       ...
       D.onText = function(a) {
        ...
        if (!t && !f["#"] && b in d) D.onTagOpen(e[b] || ""), D.onText(a);
        else {
         v();
         q();
         h || t || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
  ...
  a.prototype = {
   ...
   exec: function(a, c) {
    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
        ...
        q, v, f, y;
    for (y = 0; y < l; y++)
     if (d && (q = c.type, v = c.name), f = k[y], !(a.nonEditable && !f.options.applyToAll ||
    ...
    return function(h) {
     if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
      var e = [],
          ...
          t, G;
      if (m)
       for (p(m, 1) && e.push(m); m;) g(m) && (t = c(m)) && p(t) && ((G = c(t)) && !g(G) ? e.push(t) : (f(x).insertAfter(t), t.remove())), m = m.previous;
 ...
 (function() {
  ...
  CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
   ...
   filter: function(a, b) {
    ...
    for (q in k) {
     for (l = k[q];;)
      if (v = a.onAttributeName(b, q))
       if (v != q) delete k[q], q = v;
       else break;
      else {
       delete k[q];
       break
 ...
 (function() {
  ...
  CKEDITOR.editable = CKEDITOR.tools.createClass({
   ...
   proto: {
    ...
    insertElementIntoRange: function(a, b) {
     ...
     if (f)
      for (;
          (g = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[g.getName()]) &&
  ...
  n = function() {
   ...
   var B = CKEDITOR.dtd,
       ...
       v = CKEDITOR.tools.extend({}, B.$inline);
   delete v.br;
   return function(n, E, C, I) {
    ...
    if (!I.checkReadOnly()) {
     ...
     for (;
         (r = e(E)) && a(r) && r.isBlockBoundary() && K.contains(r);) E.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
     ...
     if (L = C) {
      ...
      if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
       ...
       if (1 == r.getChildCount() && a(y = r.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) {
        ...
        L = 0;
        for (I = A.count(); L < I; L++)
         if (E = A.getItem(L), !E.is(v)) break a;
  ...
  CKEDITOR.dom.selection.prototype = {
   ...
   getRanges: function() {
    var a = n ? function() {
     ...
     var b = function(b, c) {
      ...
      for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, C = -1, m, n; k <= l;)
       if (C = Math.floor((k + l) / 2), f = e[C], g.moveToElementText(f), m = g.compareEndPoints("StartToStart", b), 0 < m) l = C - 1;
       else if (0 > m) k = C + 1;
       else return {
         container: d,
         offset: a(f)
   ...
   getSelectedText: function() {
    ...
    var b = this.getNative(),
        b = n ? "Control" == b.type ? "" : b.createRange().text :
            b.toString();
   ...
   selectRanges: function(a) {
    ...
    if (a.length)
     if (this.isLocked) {
      ...
      a: {
       var q, v;
       if (1 == a.length && !(v = a[0]).collapsed && (l = v.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (v = v.clone(), v.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (q = v.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (l = q), "false" == l.getAttribute("contenteditable"))) break a;l = void 0
      }
      if (l) this.fake(l);
      else {
       if (n) {
        ...
        for (t = 0; t < a.length; t++) {
         ...
         try {
          ...
          if (0 <= C.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), u.setEnd(l.endContainer.$, l.endOffset);
          else throw C;
         }
         f.addRange(u)
        }
 ...
 (function() {
  ...
  function b(c) {
   var f = c.document;
   if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
   else {
    var g = this.element,
        h = this._.definition,
    ...
    for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
     ...
     if (r.equals(v)) r = null, l = !0;
      ...
      if (u && n && CKEDITOR.dtd.$block[y])
       for (var A = r, x = e(A), z = void 0, B = x.length, E = 0, A = B && new CKEDITOR.dom.range(A.getDocument()); E < B; ++E) {
        var z = x[E],
      ...
      if (x)
       if (z = r.getParent(), x = h, B = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[B] && !E || x.parentRule && !x.parentRule(z)) l = !0;
       else {
        if (t ||
         ...
         for (var y = r, P;
              (l = !y.getNext(Y)) && (P = y.getParent(), m[P.getName()]) && d(P, q, h, N);) y = P;
         t.setEndAfter(y)
        }
       }
      else l = !0;
  ...
  function D(a) {
   ...
   for (var f in b)
    if (f != this.element)
     for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || n(d, b[f])
  }
   ...
   checkElementMatch: function(a, b) {
    ...
    if ("string" == typeof this.element ? d == this.element : d in this.element) {
     ...
     if (c._length) {
      for (var h in c)
       if ("_length" != h)
        if (d = a.getAttribute(h) || "", "style" == h ? m(c[h], d) : c[h] == d) {
         if (!b) return !0
        } else if (b) return !1;
      if (b) return !0
     } else return !0
